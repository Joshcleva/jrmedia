...
function sendEmail(e) {
    ...
    return (
      <div>
        <Helmet>
          <title>JR media Photo & Video Studio</title>
          <meta
            name="description"
        ...
        <Container id="contact">
          ...
          <ContactWrapper>
            <Content>
              <Address>
                <h3>Address</h3>
                <p>1345 Nahuka Street</p>
                <p>Bumdibugyo Town, Uganda</p>
              </Address>
              <Phone>
                <h3>Phone</h3>
                <p>0772951826</p>
              ...
              <Email>
                <h3>Email</h3>
                <p>jrmediastudio256@gmail.com</p>
                <p>jackross644@outlook.com</p>
                <p>jrmedia101@email.com</p>
              </Email>
            </Content>
...
const Container = styled.div`
  ...
  padding: 20px;
  background: url("/assets/images/g1.jpg") center center / cover no-repeat
    fixed;
  h2 {
    color: #fff;
    padding-top: 80px;
