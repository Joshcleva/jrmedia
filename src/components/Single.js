      ...
      <div>
        ...
        <section class="banner-bottom py-5">
          <div class="container py-md-5">
            <h3 class="heading text-center mb-3 mb-sm-5">Videography</h3>
            <div class="single-w3pvt-page mt-md-5 mt-4 px-lg-5">
              <div class="content-sing-w3ls px-lg-5">
                ...
                <ul class="w3ls_social_list list-unstyled mt-4">
                  ...
                  <li>
                    <a href="/contact" class="w3pvt_facebook">
                      <span class="fa fa-facebook-f"></span>
                    </a>
                  </li>
                  <li class="mx-2">
                    <a href="/contact" class="w3pvt_twitter">
                      <span class="fa fa-twitter"></span>
                    </a>
                  </li>
                  <li>
                    <a href="/contact" class="w3pvt_dribble">
                      <span class="fa fa-dribbble"></span>
                    </a>
                  </li>
                  <li class="ml-2">
                    <a href="/contact" class="w3pvt_google">
                ...
                <ul class="list-unstyled">
                  <li class="media">
                    ...
                    <div class="media-body">
                      <h5 class="mt-0 mb-1">Muhindo Medard</h5>
                      <p class="mt-3">
                  ...
                  <li class="media my-5 ml-3">
                    ...
                    />
                    <div class="media-body">
                      <h5 class="mt-0 mb-1">Jackie Masika</h5>
                      <p class="mt-3">
                        Integer pulvinar leo id viverra feugiat. Pellentesque
                        Libero Justo, Semper At Tempus Vel, Ultrices In Sed
                        Ligula. Nulla Uter Sollicitudin Velit.Lorem ipsum dolor
                  ...
                  <li class="media ml-5">
                    ...
                    />
                    <div class="media-body">
                      <h5 class="mt-0 mb-1">Akankunda Marion</h5>
                      <p class="mt-3">
                        Integer pulvinar leo id viverra feugiat. Pellentesque
                        Libero Justo, Semper At Tempus Vel, Ultrices In Sed
                        Ligula. Nulla Uter Sollicitudin Velit.Lorem ipsum dolor
